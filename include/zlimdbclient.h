...
int zlimdb_copy_table(zlimdb* zdb, uint32_t table_id, uint32_t source_table_id);
int zlimdb_replace_table(zlimdb* zdb, uint32_t table_id, uint32_t source_table_id);
