...
int zlimdb_copy_table(zlimdb* zdb, uint32_t table_id, const char* name, uint32_t* new_table_id);
int zlimdb_copy_table_replace(zlimdb* zdb, uint32_t table_id, uint32_t destination_table_id);
int zlimdb_rename_table(zlimdb* zdb, uint32_t table_id, const char* name, uint32_t* new_table_id);
int zlimdb_rename_table_replace(zlimdb* zdb, uint32_t table_id, uint32_t destination_table_id);
